                ...
                <tbody>
                    {users.map(user => (
                        <tr key={user.id}>
                            ...
                            <td className="py-1">{user.role === "admin" || user.role === "owner"? (<button disabled className="bg-transparent ps-0"><i className="fa-regular fa-trash-can"></i> Delete</button>) : (<button className={`${Style.deleteBtn} ps-0 bg-transparent`} onClick={() => setUserToDelete(user)}><i className="fa-regular fa-trash-can"></i> Delete</button>)}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
